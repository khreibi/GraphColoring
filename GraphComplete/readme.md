...
Where ![Alt text describing the image](./doc/binom.gif) represents the combination formula, which is equal to ![Alt text describing the image](./doc/frac.gif).
